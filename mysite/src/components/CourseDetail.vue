        ...
        <div v-for="(item,index) in message" :key="index">
          ...
          <div id="course" style="margin-top: 66px" _v-3e2ebd6a="">
            ...
            <div style="justify-content: center; margin-top: 66px; display: none;" _v-3e2ebd6a="">
              <button class="charge-btn-fir charge-btn-active" style="margin-right: 48px" _v-3e2ebd6a="">开课时通知我</button>
            </div>
            ...
            <div class="text-center">
              ...
              <button type="button" class="btn btn-lg btn-warning" style="margin-left: 100px" v-on:click="add_car">加入购物车</button>
      ...
      add_car:function () {
        ...
        this.$axios.request({
          ...
          .then(function (res) {
            ...
            console.log(res);
            that.message = res.data.data;
            alert('加入购物车成功!');window.location.reload();
          })
          .catch(function (err) {
            console.log('连接失败' + err);
            alert('加入购物车失败!');window.location.reload();
          })
      }
    },
  }
